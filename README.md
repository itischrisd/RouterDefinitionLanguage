...
Łukasz Maśko during studies on [PJAIT](https://www.pja.edu.pl/en/).

Project's main goal is to implement a simple language that allows to define web application controllers and their
routes. JFlex and CUP were used to create a parser and lexer for the language, which has some example inputs in resource
files.
